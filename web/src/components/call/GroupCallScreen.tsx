...
import {
  ...
  MoreHorizontal, ChevronRight, Check, Maximize2, ExternalLink, Users
} from 'lucide-react';
import { CtrlBtn, CompoundBtn, VolumeSlider } from './shared/CallUIComponents';
...
export default function GroupCallScreen({
  ...
  const { tileWidth, tileHeight } = (() => {
    if (isTwoParty && !isMobile) return { tileWidth: null, tileHeight: null }; // flex: 1 mode
    const gap = 8;
    const pad = 8;
